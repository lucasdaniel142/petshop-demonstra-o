...
export const CartDrawer: React.FC<CartDrawerProps> = ({ selectedStoreLabel, selectedStoreId }) => {
  ...
  const handleCepLookup = useCallback(async (rawCep: string) => {
    ...
    try {
      ...
      // UX-03: Adicionar convite para o número após preenchimento automático
  ...
  const handleConfirmOrder = async () => {
    ...
    // Tenta obter o token se as notificações estiverem marcadas
    let finalFcmToken = fcmToken;
    if (notificationsEnabled && !fcmToken) {
      finalFcmToken = await requestNotificationToken();
      if (finalFcmToken) {
        // Salva também na coleção global de tokens para marketing futuro
    ...
    // SEC-03: Sanitização completa (Nome e Endereço)
    ...
    try {
      ...
      const orderData = {
        ...
        deliveryFee,
        total: totalGeral,
        customerName: sanitizedName.slice(0, 100), // SEC-04: Limite de tamanho
        customerPhone: cleanPhone,
        deliveryAddress: sanitizedAddress,
        cep: cep.replace(/\D/g, ''), // Salva apenas números do CEP
            ...
            <div className="p-6 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
              ...
              <div>
                <label htmlFor="cart-customer-phone" className="flex justify-between items-center text-[13px] font-[600] text-text mb-2">
                  ...
                  <span className={checkoutError !== null && !customerPhone.trim() ? 'text-red-600 font-bold opacity-100 transition-all duration-300' : 'text-red-500 opacity-50'}>
                    * Obrigatório.
                  </span>
                </label>
                <input
                  ...
                  className={`w-full rounded-[10px] border px-4 py-3 text-[14px] outline-none transition-colors ${checkoutError !== null && !customerPhone.trim() ? 'border-red-500 bg-red-50' : 'border-border focus:border-primary'}`}
              ...
              <div className="p-4 bg-gray-50 border border-gray-100 rounded-xl space-y-3">
                <label htmlFor="cart-payment" className="block text-[13px] font-[800] text-text uppercase tracking-wider">
                ...
                {paymentMethod === 'Dinheiro' && (
                  <div className="pt-2 animate-in fade-in slide-in-from-top-2">
                    <label htmlFor="cart-change" className="block text-[13px] font-[600] text-text mb-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="Ex: 100,00 (Deixe em branco se não precisar)"
                      />
                    </div>
                  </div>
                )}
            ...
            <div className="px-6 pb-2">
              <label className="flex items-start gap-2 cursor-pointer">
                ...
                <span className="text-[12px] text-gray-600 leading-snug">
                  ...
                  . Autorizo o uso dos meus dados para o pedido.
                </span>
              </label>
              ...
              <label className="flex items-center gap-2 cursor-pointer mt-2 bg-primary/5 p-3 rounded-lg border border-primary/10">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-muted leading-tight">
                    Avisaremos quando seu pedido sair para entrega ou for concluído.
                  </span>
                </div>
              </label>
            </div>
